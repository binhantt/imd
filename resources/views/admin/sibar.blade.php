<aside id="sidebar" class="flex hidden fixed top-0 left-0 z-20 flex-col flex-shrink-0 pt-16 w-64 h-full duration-200 lg:flex transition-width __web-inspector-hide-shortcut__" aria-label="Sidebar">
        ...
        <div class="flex overflow-y-auto flex-col flex-1 pt-8 pb-4">
            <div class="flex-1 px-3 bg-gray-50" id="sidebar-items">
                <ul class="pb-2 pt-1">
                    ...
                    <li>
                        <a href="{{asset('dashboard')}}" target="_blank" class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-violet-500 group transition-all duration-200" sidebar-toggle-collapse="">
                            <div class="bg-white shadow-lg shadow-gray-300  bg-fuchsia-500 !text-white  text-dark-700 w-8 h-8 p-2.5 mr-1 rounded-lg text-center grid place-items-center">
                                <i class="fa-solid fa-gauge text-black"></i>
                            </div>
                            <span class="ml-3 text-black text-sm font-light" sidebar-toggle-item="">Dashboard</span>
                        </a>
                    </li>
                    <li>
                        <a href="" target="_blank" class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-violet-500 group transition-all duration-200" sidebar-toggle-collapse="">
                            ...
                            <span class="ml-3 text-black text-sm font-light" sidebar-toggle-item="">Kanban</span>
                            <span class="bg-fuchsia-50 text-fuchsia-800 ml-auto text-sm font-medium inline-flex items-center justify-center px-2 rounded-full">Pro</span>
                        </a>
                    </li>
                    <li>
                        <a href="" target="_blank" class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-violet-500 group transition-all duration-200" sidebar-toggle-collapse="">
                            ...
                            <span class="ml-3 text-black text-sm font-light" sidebar-toggle-item="">Inbox</span>
                            <span class="bg-fuchsia-50 text-fuchsia-800 ml-auto text-sm font-medium inline-flex items-center justify-center px-2 rounded-full">Pro</span>
                        </a>
                    </li>
                    <li>
                        <a href="" class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-violet-500  group transition-all duration-200" sidebar-toggle-collapse="">
                            <div class="bg-white shadow-lg shadow-gray-300  text-dark-700 w-8 h-8 p-2.5 mr-1 rounded-lg text-center grid place-items-center">
                            ...
                            <span class="ml-3 text-black text-sm font-light" sidebar-toggle-item="">Users</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('dashboard/products') }}" class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-violet-500  group transition-all duration-200" sidebar-toggle-collapse="">
                            <div class="bg-white shadow-lg shadow-gray-300  text-dark-700 w-8 h-8 p-2.5 mr-1 rounded-lg text-center grid place-items-center">
                            ...
                            <span class="ml-3 text-black text-sm font-light" sidebar-toggle-item="">Sản Phẩm</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{route('user')}}" class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-violet-500 group transition-all duration-200" sidebar-toggle-collapse="">
                            <div class="bg-white shadow-lg shadow-gray-300 text-dark-700 w-8 h-8 p-2.5 mr-1 rounded-lg text-center grid place-items-center">
                            ...
                            <span class="ml-3 text-black text-sm font-light" sidebar-toggle-item="">ĐĂNG NHẬP</span>
                        </a>
                    </li>
                    <li>
                        <a href="" class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-violet-500 group transition-all duration-200" sidebar-toggle-collapse="">
                            ...
                            <span class="ml-3 text-black text-sm font-light" sidebar-toggle-item="">Sign Up</span>
                        </a>
                    </li>
                </ul>
                ...
                <div class="pt-2">
                    <a href="" target="_blank" class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-violet-500 group transition-all duration-200" sidebar-toggle-collapse="">
                        ...
                        <span class="ml-3 text-black text-sm font-light" sidebar-toggle-item="">Upgrade to Pro</span>
                    </a>
                    <a href="" target="_blank" class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-violet-500 group transition-all duration-200" sidebar-toggle-collapse="">
                        <div class="bg-white shadow-lg shadow-gray-300 text-dark-700 w-8 h-8 p-2.5 mr-1 rounded-lg text-center grid place-items-center">
                        ...
                        <span class="ml-3 text-black text-sm font-light" sidebar-toggle-item="">Docs</span>
                    </a>
                    <a href="" target="_blank" class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-violet-500 group transition-all duration-200" sidebar-toggle-collapse="">
                        <div class="bg-white shadow-lg shadow-gray-300 text-dark-700 w-8 h-8 p-2.5 mr-1 rounded-lg text-center grid place-items-center">
                            <svg class="text-dark mb-1" width="12px" height="12px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <span class="ml-3 text-black text-sm font-light" sidebar-toggle-item="">Components</span>
                    </a>
                </div>
            </div>
        </div>
